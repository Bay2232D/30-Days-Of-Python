...
class Mamalia(Hewan):
    def _init_(self, nama, jenis, mamalia_bertelur):
        super()._init_(nama, jenis)
        self.mamalia_bertelur = mamalia_bertelur

class Unggas(Hewan):
    def _init_(self, nama, jenis, unggas_terbang):
        super()._init_(nama, jenis)
        self.unggas_terbang = unggas_terbang

class Gajah(Mamalia):
    def _init_(self, nama, jenis, mamalia_bertelur, berat_badan):
        super()._init_(nama, jenis, mamalia_bertelur)
        self.berat_badan = berat_badan

class Ayam(Unggas):
    def _init_(self, nama, jenis, unggas_terbang, jumlah_telur):
        super()._init_(nama, jenis, unggas_terbang)
